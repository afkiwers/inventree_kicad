    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="Footprint parameter template for this category, will use KICAD_FOOTPRINT_PARAMETER setting if not set",
                null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "parameter_value",
                    models.CharField(
                        max_length=200, verbose_name="Footprint Parameter Value"
                    ),
                ),
                (
                    "kicad_footprint",
                    models.CharField(max_length=200, verbose_name="KiCad Footprint"),
                ),
                (
                    "kicad_category",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="inventree_kicad.selectedcategory",
                    ),
                ),
            ],
            options={
